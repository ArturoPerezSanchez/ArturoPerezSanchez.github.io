...
SNAKE.Snake = SNAKE.Snake || (function() {
    ...
    */
    return function(config) {
        ...
        // ----- public variables -----
        me.snakeBody = {};
        me.snakeBody["0"] = new SnakeBlock(); // create snake head
        me.snakeBody["0"].row = config.startRow || 1;
        me.snakeBody["0"].col = config.startCol || 1;
        me.snakeBody["0"].xPos = me.snakeBody["0"].row * playingBoard.getBlockWidth();
        me.snakeBody["0"].yPos = me.snakeBody["0"].col * playingBoard.getBlockHeight();
        me.snakeBody["0"].elm = createSnakeElement();
        me.snakeBody["0"].elmStyle = me.snakeBody["0"].elm.style;
        playingBoard.getBoardContainer().appendChild( me.snakeBody["0"].elm );
        me.snakeBody["0"].elm.style.left = me.snakeBody["0"].xPos + "px";
        me.snakeBody["0"].elm.style.top = me.snakeBody["0"].yPos + "px";
        me.snakeBody["0"].next = me.snakeBody["0"];
        me.snakeBody["0"].prev = me.snakeBody["0"];

        me.snakeLength = 1;
        me.snakeHead = me.snakeBody["0"];
        me.snakeTail = me.snakeBody["0"];
